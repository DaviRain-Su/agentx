...
用户打开 Terminal
    ↓
选择 "Official Agents" → 选择 "Gradience Assistant"
    ↓
免费开始对话 (limit: 50 messages/day)
    ↓
Agent 运行在 CodeFlare/Gradience Worker
```
...
| Agent | 功能 | 限制 | 运行位置 |
|-------|------|------|----------|
| Gradience Assistant | 平台介绍、基础问答 | 50 msg/day | CodeFlare Worker |
| Demo Price Monitor | 示例价格监控 | 只读、延迟5min | Gradience Worker |
